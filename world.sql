...
-- Volcando estructura para tabla freedbtech_dbeaga.world_tbl_city
CREATE TABLE IF NOT EXISTS `world_tbl_city` (
...
) ENGINE=InnoDB AUTO_INCREMENT=4080 DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC;

-- Volcando datos para la tabla freedbtech_dbeaga.world_tbl_city: ~4,046 rows (aproximadamente)
/*!40000 ALTER TABLE `world_tbl_city` DISABLE KEYS */;
INSERT INTO `world_tbl_city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES
...
/*!40000 ALTER TABLE `world_tbl_city` ENABLE KEYS */;

-- Volcando estructura para tabla freedbtech_dbeaga.world_tbl_country
CREATE TABLE IF NOT EXISTS `world_tbl_country` (
...
-- Volcando datos para la tabla freedbtech_dbeaga.world_tbl_country: ~239 rows (aproximadamente)
/*!40000 ALTER TABLE `world_tbl_country` DISABLE KEYS */;
INSERT INTO `world_tbl_country` (`Code`, `Name`, `Continent`, `Region`, `SurfaceArea`, `IndepYear`, `Population`, `LifeExpectancy`, `GNP`, `GNPOld`, `LocalName`, `GovernmentForm`, `HeadOfState`, `Capital`, `Code2`) VALUES
...
/*!40000 ALTER TABLE `world_tbl_country` ENABLE KEYS */;

-- Volcando estructura para tabla freedbtech_dbeaga.world_tbl_countrylanguage
CREATE TABLE IF NOT EXISTS `world_tbl_countrylanguage` (
  `CountryCode` char(3) NOT NULL DEFAULT '',
...
-- Volcando datos para la tabla freedbtech_dbeaga.world_tbl_countrylanguage: ~984 rows (aproximadamente)
/*!40000 ALTER TABLE `world_tbl_countrylanguage` DISABLE KEYS */;
INSERT INTO `world_tbl_countrylanguage` (`CountryCode`, `Language`, `IsOfficial`, `Percentage`) VALUES
	('ABW', 'Dutch', 'T', 5.3),
	('ABW', 'English', 'F', 9.5),
